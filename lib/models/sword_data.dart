...
class SwordData {
  ...
  SkillType get primarySkillType => skills.isNotEmpty ? skills.first.type : SkillType.slash;
  ...
  int getSellPrice(int level) {
    ...
    if (level > 0) {
      if (level <= 10) {
        ...
        levelBonus = 30000 + (level - 10) * (level - 10) * 2100;  // +20 = 30,000 + 210,000 = 240,000
      } else if (level <= 30) {
        levelBonus = 240000 + (level - 20) * (level - 20) * 6600;  // +30 = 240,000 + 660,000 = 900,000
      } else {
