...
class SoundService {
  ...
  static const String bgmMinigame = '${_soundPath}bgm_minigame.mp3';
  ...
  static const String sfxSwordShoot = '${_soundPath}sfx_sword_shoot.mp3';
  ...
  // 🎵 미니게임 BGM
  Future<void> playMinigameBgm() async {
    await playBgm(bgmMinigame);
  }
  ...
  // 🔊 검 발사
  Future<void> playSwordShoot() async {
    await playSfx(sfxSwordShoot);
  }
